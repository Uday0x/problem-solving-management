...
//Scenario :user will open a problem solve it and run submit button (then the backend will run execute code api)
//user code + problem testcases is sent to judge0 detailed output is returned 
...
export const executeCode = async (req, res) => {
    ...
    //do the validations whether the stdin s array or not
    //craete submissions 
    ...
    try {
        ...
        const submission = await db.submission.create({
            data: {
                ...
                //stdin is optional in datsbse using .some method we check whether it is present or not later we get it
